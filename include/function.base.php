...
function esc_sql($str) {
    ...
    $db = get_conn(); return $db->strescape($str);
 ...
 * @version $Id: cookie.php 673 2010-11-28 17:04:33Z mylukin $
...
function inquiry_add($title,$name,$email,$content,$phone,$country,$address,$fromcompany) {

    $db = get_conn();

	$data = array('blog' => 'http://feedback.sbmchina.org',
 ...
 * @version $Id: pages.php 690 2010-12-06 19:23:27Z mylukin $
